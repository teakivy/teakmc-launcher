...
const options = [
  {
    ...
    label: (
      <span key={1}>
        <img
          key={3}
          src={require("../../assets/installations/default.png").default}
          width={30}
          className="imgOptImg"
        />{" "}
...
const verOptions = [
  {
    value: { number: "1.18.2", type: "release" },
    label: <span className="verOptTitle">1.18.2</span>,
  },
  {
      ...
      <div>
        ...
        <div className="selectButtons">
          ...
          <Link to="/installations" replace>
            <div className="selectButton selectInstallation selectButtonActive">
              Installations
            </div>
          </Link>
        ...
        <div className="inOptView">
          ...
          <div className="inOptJava">
            <div className="installationJavaText inOptText">
              Java Executable
            </div>
            <input
              type="text"
          ...
          <div className="inOptRam">
            <div className="installationMemText inOptText">
              Allocated Memory
            </div>
          ...
          <div className="inOptButtons">
            ...
            <button
              className="inOptSave inOptButton"
              onClick={this.saveInstallation}
            >
              Save
            </button>
          </div>
...
function getMarks(maxMem) {
  ...
  if (maxMem >= 2048 && maxMem < 49152)
    marks[2048] = { style: markStyle, label: "2G" };
  if (maxMem >= 3072 && maxMem < 49152)
    marks[3072] = { style: markStyle, label: "3G" };
  if (maxMem >= 4096) marks[4096] = { style: markStyle, label: "4G" };
  if (maxMem >= 6144 && maxMem < 49152)
    marks[6144] = { style: markStyle, label: "6G" };
